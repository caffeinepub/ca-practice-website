...
const Hero = () => {
  ...
  return (
    ...
    >
      ...
      >
        <div className="absolute inset-0 bg-gradient-to-r from-primary/95 via-primary/85 to-primary/75 animate-gradient" 
             style={{
               backgroundImage: 'linear-gradient(135deg, oklch(0.45 0.14 160 / 0.95), oklch(0.50 0.15 155 / 0.90), oklch(0.55 0.12 165 / 0.85), oklch(0.48 0.13 160 / 0.90))'
             }} />
      </div>
